  ...
  <div class="grid grid-cols-3">
      ...
      @enderror
        ...
        <div class="flex flex-col gap-2">
          ...
          <input type="text" id="phone_number" name="phone_number"
            ...
            class="px-3 py-2 border border-zinc-300 bg-slate-50" placeholder="Phone number (e.g., 081234567891)">
          @error('phone_number')
        <div class="text-red-500">{{ $message }}</div>
      @enderror
        </div>
    ...
    @enderror
      ...
      <div class="flex flex-col gap-2">
        ...
        <option value="{{ $major->id }}" {{ old('majors', $student->major_id) == $major->id ? 'selected' : '' }}>
        {{ $major->name }}
        </option>
      @endforeach
        </select>
