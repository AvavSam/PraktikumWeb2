    ...
    <form action="{{ route('students.store') }}" method="POST"
      ...
      @enderror
        ...
        <div class="flex flex-col gap-2">
          ...
          <input type="text" id="student_id_number" name="student_id_number"
            class="px-3 py-2 border border-zinc-300 bg-slate-50" placeholder="Student ID (e.g., 15512201)"
      ...
      @enderror
        ...
        <div class="flex flex-col gap-2">
          ...
          <input type="text" id="phone_number" name="phone_number" class="px-3 py-2 border border-zinc-300 bg-slate-50"
      ...
      @enderror
        ...
        <div class="flex flex-col gap-2">
          ...
          <input type="date" id="birth_date" name="birth_date" class="px-3 py-2 border border-zinc-300 bg-slate-50"
